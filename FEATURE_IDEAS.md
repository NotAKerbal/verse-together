...
3. Lesson mode relaunch with live session controls
- Re-enable `/lessons` and ship teacher controls (lock card, reveal answers, timer).
- Current context: lesson backend exists in `convex/lessons.ts`, but UI route is disabled.
...
5. Verse-linked personal annotation layer
...
6. Weekly study plans + streak tracking
...
7. Better social feed ranking + following
...
8. Shared study groups (persistent, not only friendships)
...
1. Cloud-synced folders for notes
2. Full-text note search
3. Lesson mode relaunch with live controls
4. Insight version history
5. Verse-linked annotations
6. Weekly study plans + streaks
7. Feed ranking + following
8. Shared study groups
9. Citation/source graph
10. Mobile quick-capture actions
